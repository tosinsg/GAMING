    ...
    <div className="py-12 bg-black">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <h1 className="font-gaming text-4xl md:text-5xl text-white mb-8">
          Contact <span className="text-red-500">FF Arena</span>
        </h1>
        <p className="text-gray-300 mb-12 text-lg max-w-3xl">
          Have questions, suggestions, or want to collaborate? Reach out to us using the form below and we'll get back
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
          <Card className="bg-gray-800 border-red-500/20 overflow-hidden">
            <CardContent className="p-8">
              <h2 className="font-gaming text-2xl text-white mb-6">Send Us a Message</h2>
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <Button
                  ...
                  className="bg-red-600 hover:bg-red-700 text-white font-gaming w-full"
                >
          ...
          <div>
            <Card className="bg-gray-800 border-red-500/20 overflow-hidden mb-8">
              <CardContent className="p-8">
                <h2 className="font-gaming text-2xl text-white mb-6">Contact Information</h2>
            ...
            <Card className="bg-gray-800 border-red-500/20 overflow-hidden">
              <CardContent className="p-8">
                <h2 className="font-gaming text-2xl text-white mb-6">Follow Us</h2>
